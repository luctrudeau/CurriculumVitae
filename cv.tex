...
\end{cvcolumns}
\cvitem{2016}{Reviewer for IEEE Transactions on Broadcasting and IET Electronic Letters.}
...
\begin{cvcolumns}
  \cvcolumn{\normalsize{Summary of the skills acquired during my Master's:}}{%
    \small{\begin{itemize}%
      ...
      \item OpenCV and Matlab prototypes that interact with the reference H.264 software decoder (C/C++).
